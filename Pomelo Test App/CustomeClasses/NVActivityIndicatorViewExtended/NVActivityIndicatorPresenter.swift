...
//
    ...
    private struct NVActivityIndicatorPStateWaitingToStart: NVActivityIndicatorPresenterState {
        func startAnimating(presenter: NVActivityIndicatorPresenter, _ fadeInAnimation: FadeInAnimation?) {
    ...
    private struct NVActivityIndicatorPresenterAnimating: NVActivityIndicatorPresenterState {
    ...
    private struct NVActivityIndicatorPStateWaitingToStop: NVActivityIndicatorPresenterState {
        func startAnimating(presenter: NVActivityIndicatorPresenter, _ fadeInAnimation: FadeInAnimation?) {
    ...
    public final class NVActivityIndicatorPresenter {
        fileprivate enum State: NVActivityIndicatorPresenterState {
            ...
            var performer: NVActivityIndicatorPresenterState {
                switch self {
                case .waitingToStart: return NVActivityIndicatorPStateWaitingToStart()
                case .animating: return NVActivityIndicatorPresenterAnimating()
                case .waitingToStop: return NVActivityIndicatorPStateWaitingToStop()
        ...
        fileprivate func show(with activityData: ActivityData, _ fadeInAnimation: FadeInAnimation?) {
            ...
            ({
                let msgLbl = messageLabel
                let constant = activityData.messageSpacing
                let spacingConstraint = NSLayoutConstraint(item: msgLbl, attribute: .top, relatedBy: .equal, toItem: activityIndicatorView, attribute: .bottom, multiplier: 1, constant: constant)
